...
function MuscleSilhouetteFront({ pp, fp, gender }) {
  ...
  return (
    <g>
      ...
      {fem ? (
        <>
          <path d="M47,83 C45,87 45,92 47,96 C50,97 53,96 54,92 L54,84 C52,83 49,82 47,83 Z" {...pp('Abs')} />
          <path d="M56,84 L56,92 C57,96 60,97 63,96 C65,92 65,87 63,83 C61,82 58,83 56,84 Z" {...pp('Abs')} />
          <path d="M46,97 C45,102 45,108 47,112 C50,113 53,112 54,108 L54,98 C51,97 48,97 46,97 Z" {...pp('Abs')} />
          <path d="M56,98 L56,108 C57,112 60,113 63,112 C65,108 65,102 64,97 C62,97 59,97 56,98 Z" {...pp('Abs')} />
          <path d="M48,113 C47,117 49,121 55,122 L55,113 Z" {...pp('Abs')} />
          <path d="M55,113 L55,122 C61,121 63,117 62,113 Z" {...pp('Abs')} />
          <path d="M35,82 C36,94 38,108 44,118 C45,106 45,94 47,83 C42,84 38,83 35,82 Z" {...pp('Abs')} />
          <path d="M75,82 C74,94 72,108 66,118 C65,106 65,94 63,83 C68,84 72,83 75,82 Z" {...pp('Abs')} />
          <path d="M55,84 L55,121" {...fp('Abs')} />
          <path d="M46,96 C51,97 59,97 64,96" {...fp('Abs')} />
          <path d="M46,112 C51,113 59,113 64,112" {...fp('Abs')} />
        </>
      ) : (
        <>
          <path d="M46,83 C44,88 44,93 46,97 C49,98 53,97 54,92 L54,84 C51,83 48,82 46,83 Z" {...pp('Abs')} />
          <path d="M56,84 L56,92 C57,97 61,98 64,97 C66,93 66,88 64,83 C62,82 59,83 56,84 Z" {...pp('Abs')} />
          <path d="M45,98 C44,103 44,109 47,113 C50,114 53,113 54,108 L54,99 C51,98 48,98 45,98 Z" {...pp('Abs')} />
          <path d="M56,99 L56,108 C57,113 60,114 63,113 C66,109 66,103 65,98 C62,98 59,98 56,99 Z" {...pp('Abs')} />
          <path d="M47,114 C46,118 49,121 55,122 L55,114 Z" {...pp('Abs')} />
          <path d="M55,114 L55,122 C61,121 64,118 63,114 Z" {...pp('Abs')} />
          <path d="M32,80 C34,94 37,108 45,118 C45,105 44,93 46,82 C40,83 36,82 32,80 Z" {...pp('Abs')} />
          <path d="M78,80 C76,94 73,108 65,118 C65,105 66,93 64,82 C70,83 74,82 78,80 Z" {...pp('Abs')} />
          <path d="M55,84 L55,121" {...fp('Abs')} />
          <path d="M46,97 C51,98 59,98 64,97" {...fp('Abs')} />
          <path d="M45,113 C51,114 59,114 65,113" {...fp('Abs')} />
        </>
      )}
